...
- If the latest customer reply is only courtesy like "thanks", "thank you", "you're welcome", "ok", or "no problem" after a satisfied close, mark satisfied and set reply to "".
